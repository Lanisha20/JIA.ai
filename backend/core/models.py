...
class Cauldron(Base, TimestampMixin):
    ...
    max_volume: Mapped[Optional[float]] = mapped_column(Float)
    fill_rate: Mapped[Optional[float]] = mapped_column(Float)
    extra: Mapped[Dict[str, Any]] = mapped_column(JSON, default=dict)

    levels: Mapped[list[CauldronLevel]] = relationship("CauldronLevel", back_populates="cauldron")
    tickets: Mapped[list[Ticket]] = relationship("Ticket", back_populates="cauldron")
    matches: Mapped[list[MatchRecord]] = relationship("MatchRecord", back_populates="cauldron")
    drain_events: Mapped[list[DrainEvent]] = relationship("DrainEvent", back_populates="cauldron")
...
class CauldronLevel(Base, TimestampMixin):
    ...
    cauldron_id: Mapped[str] = mapped_column(String, ForeignKey("cauldrons.id", ondelete="CASCADE"), index=True)
...
class Ticket(Base, TimestampMixin):
    ...
    cauldron_id: Mapped[Optional[str]] = mapped_column(String, ForeignKey("cauldrons.id", ondelete="SET NULL"))
    ...
    matches: Mapped[list[MatchRecord]] = relationship("MatchRecord", back_populates="ticket")
...
class DrainEvent(Base, TimestampMixin):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    cauldron_id: Mapped[str] = mapped_column(String, ForeignKey("cauldrons.id", ondelete="CASCADE"), index=True)
    detected_at: Mapped[datetime] = mapped_column(DateTime(timezone=False))
...
class MatchRecord(Base, TimestampMixin):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    cauldron_id: Mapped[str] = mapped_column(String, ForeignKey("cauldrons.id", ondelete="CASCADE"), index=True)
    ticket_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("tickets.id", ondelete="SET NULL"))
    drain_event_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("drain_events.id", ondelete="SET NULL"))
    ...
    drain_event: Mapped[Optional[DrainEvent]] = relationship("DrainEvent")
